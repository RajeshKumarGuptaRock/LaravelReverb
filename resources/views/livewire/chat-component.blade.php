...
<div style="overscroll-behavior: none;">
      ...
      >
        ...
        <a style="color:black" href="/dashboard">
          <svg
        ...
        <div style="color:red" class="my-3 text-green-100 font-bold text-lg tracking-wide">{{$user->name}}</div>
        <!-- 3 dots -->
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <div class="mt-20 mb-16">
        ...
        <div class="clearfix  w-4/4">
          <div class="text-right">
            <p class="bg-green-300 t mx-4 my-2 p-2 rounded-lg inline-block">
